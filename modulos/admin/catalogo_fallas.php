<?php
/**
 * Pagina para administrar los catalogos de las fallas
                ...
                <div class="panel panel-dark">
                    <div class="panel-head">
                        <div class="panel-title">
                            ...
                            <span class="panel-title-text">Selecciona un Catalogo: </span>');
...
$css->PageFin();
print('<script src="jsPages/catalogo_fallas.js"></script>');
$css->Cbody();
$css->Chtml();
