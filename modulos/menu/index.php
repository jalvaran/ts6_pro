...
<head>
    ...
    <title>Apez Admin Template | Collapse Menu Layout</title>
...
<body>
        ...
        <div id="main-wrapper" class="menu-fixed page-hdr-fixed page-menu-small">
            ...
            <div class="menu-wrapper">
                <div class="menu">
                    ...
                    <ul>
                        ...
                        <li class="menu-title">Cryptocoin Pages</li>
                        <li class="has-sub">
                        ...
                        <li class="has-sub active">
                            <a><i class="ti-layout-width-full"></i><span>Layout</span><i class="arrow rotate"></i></a>
                            <ul class="sub-menu">
                                <li>
            ...
            <div class="page-wrapper">
                ...
                <div class="page-title">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h2 class="page-title-text">Collapsed Menu Layout</h2>
                        </div>
                        <div class="col-sm-6 text-right">
                            <div class="breadcrumbs">
                                <ul>
                                    <li><a href="#">Home</a></li>
                                    <li>Collapsed Menu Layout</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-head">
                            <div class="panel-title">
                                <span class="panel-title-text">Collapse Menu Layout</span>
                            </div>
                        </div>
    ...
    <!-- Raphael Plugin -->
    <script type="text/javascript" src="../../assets/plugin/prism/prism.js"></script>
