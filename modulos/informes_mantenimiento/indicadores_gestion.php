<?php
/**
 * Pagina para realizar los indicadores de gestion
...
$myPage=$Pagina;
$myTitulo="Indicadores de Gestión";
                ...
                <div class="panel panel-dark">
                    <div class="panel-head">
                        <div class="panel-title">
                            ...
                            <span class="panel-title-text">Indicadores de Gestión: </span>  
                            <div class="row">
                            <div class="col-md-4">
                                ');
...
$css->PageFin();
print('<script src="jsPages/indicadores_gestion.js"></script>'); 
$css->Cbody();
$css->Chtml();
