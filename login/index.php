...
<html lang="spa">
    ...
    <head>
        ...
        <link rel='shortcut icon' href='../images/favicontechno.png'>       
    ...
    <body>
        	...
        	<div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1>Iniciar Sesión en Plataforma TS6 PRO</h1>
                        <div class="description">
                        	<p>
	                         	Plataforma de Control de Procesos Empresariales 
	                         	Creada por Techno Soluciones SAS en asociación con PRODG LTDA, 
                ...
                <div class="row register-form">
                    ...
                    <div class="col-sm-6 forms-right-icons">
							...
							<div class="col-sm-10">
								...
								<p>Gestión de Mantenimiento, Gestión de Calidad, Gestión Comercial, Gestión de los servicos en la salud, Servicio al Cliente, Gestión del Talento Humano, Compras, Inventarios, Gestión Administrativa y Financiera.</p>
							</div>
						</div>
						<div class="row">
        	...
        	<div >
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p>&copy; <?php echo date("Y");?> | <a href="#">Privacy Policy</a> <br> Software  diseñado por Techno Soluciones SAS en asociación con PRODG LTDA. (057) 317 774 0609</p>
        			</div>
        ...
        <script src="../assets/plugin/alertify/lib/alertify.min.js"></script>
